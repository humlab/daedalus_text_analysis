...
def main():
    ...
    source_name = './data/segmented-yearly-volumes_2015-2017_articles.zip'
    target_name = './data/daedalus_articles_pos_xml_2015-2017.zip'
    service.annotate_files_in_archive(source_name, target_name)
